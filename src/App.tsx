  ...
  if (publicToken && (!userAddress || isNaN(userBalance))) {
    return (
      <div className="main-box">
        ...
        <div id="dialog">
          <header>Sociallocket Hackathon | Hyperglade</header>
          <div id="content">
        ...
        <div id="footer">
          <img src="built-with-taquito.png" alt="Built by Sociallocket" />
        </div>
      </div>
    );
          ...
          <div id="content">
            ...
            <p>
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                <strong>Sociallocket.com</strong>
              </a>{" "}
